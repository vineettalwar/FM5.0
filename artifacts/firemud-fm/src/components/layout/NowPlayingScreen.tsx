  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center pt-4 pb-2 px-4 shrink-0">
        <div className="w-12 h-1.5 bg-white/20 rounded-full mb-4 cursor-pointer" onClick={() => setIsExpanded(false)} />
        <div className="w-full flex justify-between items-center">
          <Button variant="ghost" size="icon" onClick={() => setIsExpanded(false)} className="text-white hover:bg-white/10 rounded-full">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center p-6 sm:p-12 min-h-0 overflow-y-auto scrollbar-none pb-24">
        ...
        <div className="relative mb-10 shrink-0 w-64 h-64 sm:w-80 sm:h-80">
          <div className="absolute inset-0 rounded-3xl opacity-50 scale-105" style={{ background: `radial-gradient(circle, hsl(var(--ambient)) 0%, transparent 70%)`, filter: 'blur(30px)' }} />
        ...
        <div className="w-full max-w-md flex flex-col gap-8 mb-8 shrink-0">
          <div className="flex items-center justify-between px-4 sm:px-8">
            <Button variant="ghost" size="icon" onClick={handleFavoriteClick} className="h-12 w-12 rounded-full text-white/60 hover:text-white hover:bg-white/10">
            ...
            <div className="w-12 h-12" /> {/* Empty space to balance heart */}
          </div>

          {/* Volume */}
          <div className="flex items-center gap-4 w-full px-6">
            <Button variant="ghost" size="icon" className="text-white/60" onClick={() => setVolume(volume === 0 ? 0.8 : 0)}>
